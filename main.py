...
if __name__ == "__main__":
    ...
    path_file = input("Введите путь к json-файлу в который нужно создавать отчет. Если нужно сохранить путь по умолчанию то нажмите клавишу 'Enter' (файл по умолчанию /data/report.json")
    if not path_file:
        path_file = None
    main(date)